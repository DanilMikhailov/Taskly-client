...
TaskForm.propTypes = {
    type: PropTypes.string.isRequired, // Обозначение типа и обязательность пропса type
    task: PropTypes.shape({
        _id: PropTypes.string,
        due: PropTypes.oneOfType([PropTypes.instanceOf(Date), PropTypes.string]), // `due` может быть объектом Date или строкой
